@tool
class_name RoomPlacementUtils
extends RefCounted

## Centralized utility library for room object placement
## Eliminates duplicate code between generate_sarcophagus.gd and generate_statue_fountain.gd
